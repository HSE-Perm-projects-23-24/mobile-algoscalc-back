...
экземпляр класса AnswerAlgorithmDefinition. Загрузить файл алгоритма можно 
через запрос к конечной точке /api/algorithms/{algorithm_name}/download.
...
+--------+---------------------------+------------------------------------------------+
| GET    | /api/algorithms/fibonacci/download | Получить файл алгоритма fibonacci     |
+--------+---------------------------+------------------------------------------------+
